...
builder.Services.AddSingleton<IAdUserMover, LdapsAdUserMover>();
builder.Services.AddSingleton<IAdUserAttributeUpdater, LdapsAdUserAttributeUpdater>();
...
builder.Services.AddSingleton<IWorkerHandler, MoveAdUserOuLdapsHandler>();
builder.Services.AddSingleton<IWorkerHandler, UpdateAdUserAttributesLdapsHandler>();
