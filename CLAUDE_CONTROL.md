...
- nennt das echte Ergebnis ohne Beschönigung
...
- `DOCS_CONTROL.md` — zentrale Doku-Lesereihenfolge und Pflege-Regeln
- `CLAUDE.md` — allgemeine Claude-Hinweise fuer dieses Repo
- `CODE_REVIEW.md` — Review-Priorisierung und Nacharbeitslogik
- `TODO.md` — aktueller Arbeitsplan
- `CODEX_SYNC.md` — Handoff und Aenderungsprotokoll
- `KauthWorkflow/Arbeit/KI-Workflow.md` — uebergeordneter KI-Zusammenarbeitskontext
