...
OVERRIDING SYSTEM VALUE VALUES
	...
	(9, 'SendWelcomeMailGraph', 'Send Welcome Mail (Graph)', 'Versendet die Willkommens-Mail an einen frisch angelegten User via Microsoft Graph (App-only). Linux-side.', 'graph_welcome_mail', '{"type":"object","required":["toAddress","recipientName","firstName","lastName","userPrincipalName"],"additionalProperties":true}', true, false, true, '2026-05-12 00:00:00+00', '2026-05-12 00:00:00+00', NULL);
