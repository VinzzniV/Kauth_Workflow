...
OVERRIDING SYSTEM VALUE VALUES
	(1, 'CreateAdUser', 'Create AD User', 'Simulated creation of an Active Directory user.', 'simulated_directory', '{"type": "object", "additionalProperties": true}', true, false, true, '2026-04-27 07:05:50.927528+00', '2026-04-27 07:05:51.998735+00', NULL, NULL, NULL),
	(2, 'CreateMailbox', 'Create Mailbox', 'Simulated provisioning of a mailbox.', 'simulated_mailbox', '{"type": "object", "additionalProperties": true}', true, false, true, '2026-04-27 07:05:50.927528+00', '2026-04-27 07:05:51.998735+00', NULL, NULL, NULL),
	(3, 'AssignGroups', 'Assign Groups', 'Simulated assignment of directory groups.', 'simulated_directory_groups', '{"type": "object", "additionalProperties": true}', true, false, true, '2026-04-27 07:05:50.927528+00', '2026-04-27 07:05:51.998735+00', NULL, NULL, NULL),
	(4, 'CreateErpEmployee', 'Create ERP Employee', 'Simulated creation of an ERP employee.', 'simulated_erp', '{"type": "object", "additionalProperties": true}', true, false, false, '2026-04-27 07:05:50.927528+00', '2026-04-27 07:05:51.998735+00', NULL, NULL, NULL),
	(5, 'SendWelcomeMail', 'Send Welcome Mail', 'Simulated sending of a welcome email.', 'simulated_notification', '{"type": "object", "additionalProperties": true}', true, false, true, '2026-04-27 07:05:50.927528+00', '2026-04-27 07:05:51.998735+00', NULL, NULL, NULL),
	(6, 'SimulatedWindowsWorkerPing', 'Windows-Worker Ping (Skeleton-Test)', 'Simulierter Handler im Windows-Worker. Beweist den Transport- und Audit-Pfad ohne AD-Zugriff.', 'simulated_windows_worker_ping', '{"type": "object", "additionalProperties": true}', true, false, true, '2026-05-12 00:00:00+00', '2026-05-12 00:00:00+00', 'windows_worker', NULL, NULL),
	(7, 'CreateAdUserLdaps', 'Create AD User (LDAPS)', 'Echte AD-User-Anlage via LDAPS gegen on-prem-DC. Laeuft im Windows-Worker unter gMSA.', 'windows_worker_ldaps', '{"type":"object","required":["samAccountName","userPrincipalName","displayName","givenName","surname","mail","targetOu"],"additionalProperties":true}', true, false, true, '2026-05-12 00:00:00+00', '2026-05-12 00:00:00+00', 'windows_worker', NULL, NULL),
	(8, 'AssignGroupsLdaps', 'Assign AD Groups (LDAPS)', 'Fuegt den AD-User in N AD-Gruppen ein via LDAPS-ModifyRequest. Laeuft im Windows-Worker unter gMSA.', 'windows_worker_ldaps_groups', '{"type":"object","required":["userDistinguishedName","groupDistinguishedNames"],"additionalProperties":true}', true, false, true, '2026-05-12 00:00:00+00', '2026-05-12 00:00:00+00', 'windows_worker', NULL, NULL),
	(9, 'SendWelcomeMailGraph', 'Send Welcome Mail (Graph)', 'Versendet die Willkommens-Mail an einen frisch angelegten User via Microsoft Graph (App-only). Linux-side. Pflicht-Payload inkl. credentialVaultId (UUID, Vault-Pointer aus CreateAdUserLdaps).', 'graph_welcome_mail', '{"type":"object","required":["toAddress","recipientName","firstName","lastName","userPrincipalName","credentialVaultId"],"additionalProperties":true}', true, false, true, '2026-05-13 00:00:00+00', '2026-05-13 00:00:00+00', NULL, NULL, NULL),
	(10, 'CreateMailboxGraph', 'Create Exchange Mailbox (Graph)', 'Weist einem in Entra existierenden User via Microsoft Graph eine Exchange-Online-Lizenz zu. Die Mailbox wird durch Exchange Online automatisch provisioniert. Pflicht-Payload inkl. skuId (UUID). Retry-Override 10/300 fuer den Entra-Connect-Sync-Zyklus (~41 min Budget). Pflicht-Permissions: User.Read.All + LicenseAssignment.ReadWrite.All.', 'graph_mailbox_provision', '{"type":"object","required":["userPrincipalName","skuId"],"additionalProperties":true}', true, false, true, '2026-05-13 00:00:00+00', '2026-05-13 00:00:00+00', NULL, 10, 300),
	(11, 'DisableAdUserLdaps', 'Disable AD User (LDAPS)', 'Deaktiviert einen AD-User via LDAPS gegen den on-prem-DC. Laeuft im Windows-Worker unter gMSA. Setzt das ACCOUNTDISABLE-Bit (userAccountControl |= 0x2). Idempotent: bereits deaktivierter User liefert Success mit alreadyDisabled=true. Pflicht-Payload: userDistinguishedName (DN des Users). Output: distinguishedName, alreadyDisabled.', 'windows_worker_ldaps', '{"type":"object","required":["userDistinguishedName"],"additionalProperties":true}', true, false, true, '2026-05-19 00:00:00+00', '2026-05-19 00:00:00+00', 'windows_worker', NULL, NULL),
	(12, 'RemoveFromAllGroupsLdaps', 'Remove from All Groups (LDAPS)', 'Entfernt einen AD-User aus allen Gruppen via LDAPS gegen den on-prem-DC. Laeuft im Windows-Worker unter gMSA. Sucht per LDAP-Filter alle Gruppen und entfernt den User pro Gruppe. Idempotent: Code 16 (NoSuchAttribute = bereits kein Mitglied) wird als AlreadyRemoved behandelt. Pflicht-Payload: userDistinguishedName. Output: removed, alreadyRemoved, failed.', 'windows_worker_ldaps', '{"type":"object","required":["userDistinguishedName"],"additionalProperties":true}', true, false, true, '2026-05-19 00:00:00+00', '2026-05-19 00:00:00+00', 'windows_worker', NULL, NULL),
	(13, 'RemoveMailboxLicense', 'Remove Exchange Mailbox License (Graph)', 'Entfernt eine Exchange-Online-Lizenz von einem Entra-User via Microsoft Graph. Idempotent: Lizenz nicht zugewiesen liefert Success mit licenseNotAssigned=true. Pflicht-Payload: userPrincipalName, skuId (UUID). Output: userPrincipalName, licenseSkuId, licenseNotAssigned, removedAtUtc. Pflicht-Permissions: User.Read.All + LicenseAssignment.ReadWrite.All.', 'graph_mailbox_deprovision', '{"type":"object","required":["userPrincipalName","skuId"],"additionalProperties":true}', true, false, true, '2026-05-19 00:00:00+00', '2026-05-19 00:00:00+00', NULL, NULL, NULL),
	(14, 'MoveAdUserOuLdaps', 'AD-User in OU verschieben (LDAPS)', 'Verschiebt einen AD-User per LDAP ModifyDN in eine andere Organisationseinheit. Der RDN (CN) bleibt unveraendert. Laeuft im Windows-Worker unter gMSA. Idempotent: User bereits in Ziel-OU -> Success mit alreadyInTargetOu=true. Pflicht-Payload: userDistinguishedName (aktueller DN), targetOu (Ziel-OU-DN). Output: distinguishedName, fromOu, toOu, alreadyInTargetOu.', 'windows_worker_ldaps', '{"type":"object","required":["userDistinguishedName","targetOu"],"additionalProperties":true}', true, false, true, '2026-05-19 00:00:00+00', '2026-05-19 00:00:00+00', 'windows_worker', NULL, NULL),
	(15, 'UpdateAdUserAttributesLdaps', 'AD-User-Attribute aktualisieren (LDAPS)', 'Aktualisiert eine Whitelist von AD-User-Attributen via LDAPS. Whitelist: managerDistinguishedName (->manager), department, title, description. Kein UPN/mail/displayName/cn/sAMAccountName. JSON null = Attribut loeschen. Fehlendes Key = nicht anfassen. Idempotent: keine Aenderung noetig -> Success mit noChangesNeeded=true. Pflicht-Payload: userDistinguishedName + mindestens ein Whitelist-Feld. Output: distinguishedName, changedAttributes[], noChangesNeeded.', 'windows_worker_ldaps', '{"type":"object","required":["userDistinguishedName"],"additionalProperties":true}', true, false, true, '2026-05-19 00:00:00+00', '2026-05-19 00:00:00+00', 'windows_worker', NULL, NULL);
