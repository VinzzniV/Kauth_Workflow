...
OVERRIDING SYSTEM VALUE VALUES
	(1, 'CreateAdUser', 'Create AD User', 'Simulated creation of an Active Directory user.', 'simulated_directory', '{"type": "object", "additionalProperties": true}', true, false, true, '2026-04-27 07:07:09.400545+00', '2026-04-27 07:07:10.354481+00', NULL),
	(2, 'CreateMailbox', 'Create Mailbox', 'Simulated provisioning of a mailbox.', 'simulated_mailbox', '{"type": "object", "additionalProperties": true}', true, false, true, '2026-04-27 07:07:09.400545+00', '2026-04-27 07:07:10.354481+00', NULL),
	(3, 'AssignGroups', 'Assign Groups', 'Simulated assignment of directory groups.', 'simulated_directory_groups', '{"type": "object", "additionalProperties": true}', true, false, true, '2026-04-27 07:07:09.400545+00', '2026-04-27 07:07:10.354481+00', NULL),
	(4, 'CreateErpEmployee', 'Create ERP Employee', 'Simulated creation of an ERP employee.', 'simulated_erp', '{"type": "object", "additionalProperties": true}', true, false, false, '2026-04-27 07:07:09.400545+00', '2026-04-27 07:07:10.354481+00', NULL),
	(5, 'SendWelcomeMail', 'Send Welcome Mail', 'Simulated sending of a welcome email.', 'simulated_notification', '{"type": "object", "additionalProperties": true}', true, false, true, '2026-04-27 07:07:09.400545+00', '2026-04-27 07:07:10.354481+00', NULL),
	(6, 'SimulatedWindowsWorkerPing', 'Windows-Worker Ping (Skeleton-Test)', 'Simulierter Handler im Windows-Worker. Beweist den Transport- und Audit-Pfad ohne AD-Zugriff. Payload {"delaySeconds": N} verzoegert die Antwort fuer Stale-Claim-Tests.', 'simulated_windows_worker_ping', '{"type": "object", "additionalProperties": true}', true, false, true, '2026-05-12 00:00:00+00', '2026-05-12 00:00:00+00', 'windows_worker'),
	(7, 'CreateAdUserLdaps', 'Create AD User (LDAPS)', 'Echte AD-User-Anlage via LDAPS gegen on-prem-DC. Laeuft im Windows-Worker unter gMSA. Pflicht-Payload-Felder: samAccountName, userPrincipalName, displayName, givenName, surname, mail, targetOu. Optional: employeeNumber. Output liefert distinguishedName, samAccountName, userPrincipalName und temporaryPassword (Force-Change-at-Next-Logon).', 'windows_worker_ldaps', '{"type":"object","required":["samAccountName","userPrincipalName","displayName","givenName","surname","mail","targetOu"],"additionalProperties":true}', true, false, true, '2026-05-12 00:00:00+00', '2026-05-12 00:00:00+00', 'windows_worker'),
	(8, 'AssignGroupsLdaps', 'Assign AD Groups (LDAPS)', 'Fuegt den AD-User in N AD-Gruppen ein via LDAPS-ModifyRequest. Laeuft im Windows-Worker unter gMSA. Pflicht-Payload-Felder: userDistinguishedName (via created_ad_user-Source), groupDistinguishedNames (string array). Output liefert newlyAdded + alreadyMember + ggf. failed.', 'windows_worker_ldaps_groups', '{"type":"object","required":["userDistinguishedName","groupDistinguishedNames"],"additionalProperties":true}', true, false, true, '2026-05-12 00:00:00+00', '2026-05-12 00:00:00+00', 'windows_worker'),
	(9, 'SendWelcomeMailGraph', 'Send Welcome Mail (Graph)', 'Versendet die Willkommens-Mail an einen frisch angelegten User via Microsoft Graph (App-only). Linux-side. Catalog-Template welcome_mail mit {{temporary_password}}-Placeholder. Pflicht-Payload inkl. credentialVaultId (UUID, Vault-Pointer aus CreateAdUserLdaps; Handler entschluesselt zur Run-time).', 'graph_welcome_mail', '{"type":"object","required":["toAddress","recipientName","firstName","lastName","userPrincipalName","credentialVaultId"],"additionalProperties":true}', true, false, true, '2026-05-13 00:00:00+00', '2026-05-13 00:00:00+00', NULL);
