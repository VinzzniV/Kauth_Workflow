...
INSERT INTO public.app_responsibilities OVERRIDING SYSTEM VALUE VALUES
	...
	(15, NULL, 'hr_onboarding', NULL, 'HR-Onboarding', 'process', 'Verantwortung fuer Start, Abstimmung und Begleitung des Onboardings.', true, '2026-04-27 07:07:09.703692+00'),
...
INSERT INTO public.process_types OVERRIDING SYSTEM VALUE VALUES
	(1, 'onboarding', 'Onboarding', 'Start eines neuen Mitarbeiters mit Aufgaben fuer HR, Fuehrungskraft und Fachbereiche.', true, 'supervisor_fills_document', false, 'identitat', false, true, 10, '2026-04-27 07:07:09.697627+00'),
	(3, 'offboarding', 'Offboarding', 'Geordneter Abschluss eines Mitarbeiterverhältnisses mit Rückgabe aller Zugänge und Ausstattung.', false, NULL, true, 'identitat', false, true, 20, '2026-04-27 07:07:09.928722+00'),
	(4, 'department_change', 'Abteilungswechsel', 'Koordinierter Wechsel eines Mitarbeiters in eine andere Abteilung mit Anpassung aller Zugänge und Ausstattung.', false, NULL, true, 'identitat', true, true, 30, '2026-04-27 07:07:09.947742+00'),
	(5, 'name_change', 'Namensaenderung', 'Koordinierte Aktualisierung eines Mitarbeiternamens in Stammdaten, Verzeichnisdiensten und Kommunikationssystemen.', false, NULL, true, 'identitat', true, true, 40, '2026-04-27 07:07:09.961807+00'),
	(6, 'position_change', 'Positionswechsel', 'Koordinierter Wechsel eines Mitarbeiters in eine neue Position mit Anpassung von Berechtigungen, Systemzugaengen und Schulungen.', false, NULL, true, 'identitat', true, true, 50, '2026-04-27 07:07:10.023999+00'),
	(7, 'role_change', 'Rollenwechsel', 'Koordinierte Anpassung einer Mitarbeiterrolle mit gezielter Aktualisierung von Rollen- und Berechtigungszuweisungen.', false, NULL, true, 'identitat', true, true, 60, '2026-04-27 07:07:10.039596+00');
...
INSERT INTO public.workflow_definitions OVERRIDING SYSTEM VALUE VALUES
	(2, 'offboarding', 'Offboarding', 'Business-phase workflow definition mapped to the legacy offboarding task generator.', '2026-04-27 07:07:10.336213+00', '2026-04-27 07:07:10.374109+00'),
	(3, 'department_change', 'Abteilungswechsel', 'Business-phase workflow definition mapped to the legacy department change task generator.', '2026-04-27 07:07:10.339459+00', '2026-04-27 07:07:10.377381+00'),
	(7, 'name_change', 'Namensaenderung', 'Business-phase workflow definition mapped to the legacy name change task generator.', '2026-04-27 07:07:10.385153+00', '2026-04-27 07:07:10.385153+00'),
	(8, 'position_change', 'Positionswechsel', 'Business-phase workflow definition mapped to the legacy position change task generator.', '2026-04-27 07:07:10.389326+00', '2026-04-27 07:07:10.389326+00'),
	(9, 'role_change', 'Rollenwechsel', 'Business-phase workflow definition mapped to the legacy role change task generator.', '2026-04-27 07:07:10.392633+00', '2026-04-27 07:07:10.392633+00'),
	(1, 'onboarding', 'Onboarding', 'Business-phase workflow definition mapped to the legacy onboarding task generator.', '2026-04-27 07:07:10.326548+00', '2026-04-27 07:07:10.396926+00');
...
INSERT INTO public.workflow_definition_versions OVERRIDING SYSTEM VALUE VALUES
	(2, 2, 1, 'published', 'Offboarding Standard', 'Published offboarding mapping with a deprovision measure block and internal task generation.', 3, '2026-04-27 07:07:10.336213+00', '2026-04-27 07:07:10.374109+00', '2026-04-27 07:07:10.336213+00'),
	(3, 3, 1, 'published', 'Abteilungswechsel Standard', 'Published department change mapping with a change measure block and internal task generation.', 4, '2026-04-27 07:07:10.339459+00', '2026-04-27 07:07:10.377381+00', '2026-04-27 07:07:10.339459+00'),
	(4, 7, 1, 'published', 'Namensaenderung Standard', 'Published name change mapping with a rename measure block and internal task generation.', 5, '2026-04-27 07:07:10.385153+00', '2026-04-27 07:07:10.385153+00', '2026-04-27 07:07:10.385153+00'),
	(5, 8, 1, 'published', 'Positionswechsel Standard', 'Published position change mapping with a change measure block and internal task generation.', 6, '2026-04-27 07:07:10.389326+00', '2026-04-27 07:07:10.389326+00', '2026-04-27 07:07:10.389326+00'),
	(6, 9, 1, 'published', 'Rollenwechsel Standard', 'Published role change mapping with a change measure block and internal task generation.', 7, '2026-04-27 07:07:10.392633+00', '2026-04-27 07:07:10.392633+00', '2026-04-27 07:07:10.392633+00'),
	(1, 1, 1, 'published', 'Onboarding Standard', 'Published onboarding mapping with a provision measure block and internal task generation.', 1, '2026-04-27 07:07:10.326548+00', '2026-04-27 07:07:10.396926+00', '2026-04-27 07:07:10.326548+00');
...
INSERT INTO public.task_templates OVERRIDING SYSTEM VALUE VALUES
	(1, 1, 'supervisor_fills_document', 'Anforderungen auswählen und bestätigen', 'Führungskraft', 'Die Abteilungsleitung wählt die benötigten Anforderungen aus und bestätigt diese.', 'identitat', NULL, NULL, 'Abteilungsleitung', false, true, 2, 40, true, '2026-04-27 07:07:09.732801+00'),
	(3, 1, 'gewatec_user_create', 'Gewatec-User anlegen', 'Fachanwendungen', 'Gewatec-User für die neue Person anlegen.', 'berechtigungen', NULL, 4, 'AV', true, true, 3, 210, true, '2026-04-27 07:07:09.732801+00'),
	(4, 1, 'provis_user_create', 'Provis-User anlegen', 'Fachanwendungen', 'Provis-User für die neue Person anlegen.', 'berechtigungen', NULL, 3, 'AV', true, true, 3, 220, true, '2026-04-27 07:07:09.732801+00'),
	(41, 4, 'dc_habel_access_update', 'Habel-Zugang anpassen', 'Fachanwendungen', 'Habel-Berechtigungen auf die neue Abteilung umstellen.', 'habel', NULL, 10, 'IT', true, true, 3, 130, true, '2026-04-27 07:07:09.952433+00'),
	(5, 1, 'ad_user_create', 'AD-User anlegen', 'Zugänge', 'AD-User für die neue Person anlegen.', 'ad_user', NULL, 12, 'IT', true, true, 3, 100, true, '2026-04-27 07:07:09.732801+00'),
	(6, 1, 'permissions_from_reference_user', 'AD-Berechtigungen anhand Vergleichsuser übernehmen', 'Zugänge', 'AD-Berechtigungen anhand einer Vergleichsperson übernehmen.', 'berechtigungen', NULL, 12, 'IT', true, true, 3, 110, true, '2026-04-27 07:07:09.732801+00'),
	(7, 1, 'internet_access_enable', 'Internetzugang einrichten', 'Zugänge', 'Internetzugang für die neue Person freischalten.', 'internetzugang', NULL, 12, 'IT', true, true, 3, 145, true, '2026-04-27 07:07:09.732801+00'),
	(8, 1, 'internal_drive_access_grant', 'Laufwerksrechte vergeben', 'Zugänge', 'Zugriffsrechte für das interne Laufwerk der neuen Person einrichten.', 'berechtigungen', NULL, 12, 'IT', true, true, 3, 147, true, '2026-04-27 07:07:09.732801+00'),
	(9, 1, 'exchange_create', 'Mailbox anlegen', 'Zugänge', 'Mailbox für die neue Person anlegen.', 'mailbox', NULL, 11, 'IT', true, true, 3, 120, true, '2026-04-27 07:07:09.732801+00'),
	(10, 1, 'habel_user_create', 'Habel-User anlegen', 'Fachanwendungen', 'Habel-User für die neue Person anlegen.', 'habel', NULL, 10, 'IT', true, true, 3, 130, true, '2026-04-27 07:07:09.732801+00'),
	(11, 1, 'ln_user_create', 'LN-User anlegen', 'Fachanwendungen', 'LN-User für die neue Person anlegen.', 'react', NULL, 9, 'IT', true, true, 3, 140, true, '2026-04-27 07:07:09.732801+00'),
	(12, 1, 'office_install', 'Microsoft Office bereitstellen', 'Fachanwendungen', 'Microsoft Office für die neue Person bereitstellen und konfigurieren.', 'microsoft_office', NULL, 8, 'IT', true, true, 3, 148, true, '2026-04-27 07:07:09.732801+00'),
	(13, 1, 'hardware_procure', 'Hardware beschaffen', 'Ausstattung', 'Hardware-Bedarf prüfen und bei Bedarf passende Hardware beschaffen.', 'pc', NULL, 8, 'IT', true, true, 5, 150, true, '2026-04-27 07:07:09.732801+00'),
	(14, 1, 'hardware_setup', 'Hardware einrichten', 'Ausstattung', 'Hardware installieren und für den Einsatz vorbereiten.', 'pc', NULL, 8, 'IT', true, true, 3, 160, true, '2026-04-27 07:07:09.732801+00'),
	(15, 1, 'hardware_handover', 'Hardware bereitstellen', 'Ausstattung', 'Eingerichtete Hardware für die neue Person bereitstellen.', 'pc', NULL, 8, 'IT', true, true, 1, 170, true, '2026-04-27 07:07:09.732801+00'),
	(16, 1, 'phone_prepare', 'Tragbares Telefon bereitstellen', 'Ausstattung', 'Tragbares Telefon für die neue Person bereitstellen.', 'phone', NULL, 8, 'IT', true, true, 3, 175, true, '2026-04-27 07:07:09.732801+00'),
	(17, 1, 'catia_install', 'Catia bereitstellen', 'Fachanwendungen', 'Catia für die neue Person installieren und bereitstellen.', 'catia', NULL, 8, 'IT', true, true, 3, 180, true, '2026-04-27 07:07:09.732801+00'),
	(18, 1, 'datev_install', 'DATEV bereitstellen', 'Fachanwendungen', 'DATEV für die neue Person installieren und bereitstellen.', 'datev', NULL, 8, 'IT', true, true, 3, 185, true, '2026-04-27 07:07:09.732801+00'),
	(19, 1, 'tisoware_install', 'Tisoware bereitstellen', 'Fachanwendungen', 'Tisoware für die neue Person installieren und bereitstellen.', 'tiso', NULL, 8, 'IT', true, true, 3, 190, true, '2026-04-27 07:07:09.732801+00'),
	(20, 1, 'babtec_user_create', 'Babtec-User anlegen', 'Fachanwendungen', 'User in Babtec für die neue Person anlegen.', 'babtec', NULL, 16, 'QS', true, true, 3, 200, true, '2026-04-27 07:07:09.732801+00'),
	(22, 3, 'ob_gewatec_user_disable', 'Gewatec-User deaktivieren', 'Fachanwendungen', 'Gewatec-Zugang der ausscheidenden Person deaktivieren.', 'gewatec', NULL, 4, 'AV', true, true, 2, 210, true, '2026-04-27 07:07:09.937826+00'),
	(23, 3, 'ob_provis_user_disable', 'Provis-User deaktivieren', 'Fachanwendungen', 'Provis-Zugang der ausscheidenden Person deaktivieren.', 'berechtigungen', NULL, 3, 'AV', true, true, 2, 220, true, '2026-04-27 07:07:09.937826+00'),
	(24, 3, 'ob_ad_account_disable', 'AD-Konto deaktivieren', 'Zugänge', 'AD-Konto der ausscheidenden Person deaktivieren und Berechtigungen entziehen.', 'ad_user', NULL, 12, 'IT', true, true, 1, 100, true, '2026-04-27 07:07:09.937826+00'),
	(25, 3, 'ob_mailbox_disable', 'Mailbox deaktivieren', 'Zugänge', 'Mailbox der ausscheidenden Person deaktivieren.', 'mailbox', NULL, 11, 'IT', true, true, 1, 110, true, '2026-04-27 07:07:09.937826+00'),
	(26, 3, 'ob_habel_user_disable', 'Habel-User deaktivieren', 'Fachanwendungen', 'Habel-Zugang der ausscheidenden Person sperren.', 'habel', NULL, 10, 'IT', true, true, 2, 120, true, '2026-04-27 07:07:09.937826+00'),
	(27, 3, 'ob_ln_user_disable', 'LN-User deaktivieren', 'Fachanwendungen', 'InforLN-Zugang der ausscheidenden Person sperren.', 'react', NULL, 9, 'IT', true, true, 2, 130, true, '2026-04-27 07:07:09.937826+00'),
	(28, 3, 'ob_hardware_return', 'Hardware einziehen', 'Ausstattung', 'Hardware (Laptop, Workstation, Zubehör) der ausscheidenden Person einziehen und auf Vollständigkeit prüfen.', 'pc', NULL, 8, 'IT', true, true, 1, 140, true, '2026-04-27 07:07:09.937826+00'),
	(29, 3, 'ob_phone_return', 'Telefon einziehen', 'Ausstattung', 'Tragbares Telefon der ausscheidenden Person einziehen.', 'phone', NULL, 8, 'IT', true, true, 1, 150, true, '2026-04-27 07:07:09.937826+00'),
	(30, 3, 'ob_last_day_confirmed', 'Letzten Arbeitstag bestätigen', 'HR', 'Letzten Arbeitstag der ausscheidenden Person im System bestätigen. Schaltet alle Zugangs-Entzug-Aufgaben frei.', 'identitat', NULL, 15, 'HR', true, true, 1, 10, true, '2026-04-27 07:07:09.937826+00'),
	(31, 3, 'ob_exit_interview', 'Austrittsgespräch führen', 'HR', 'Strukturiertes Abschlussgespräch mit der ausscheidenden Person führen und dokumentieren.', 'identitat', NULL, 15, 'HR', true, true, 5, 20, true, '2026-04-27 07:07:09.937826+00'),
	(32, 3, 'ob_knowledge_transfer', 'Wissenstransfer organisieren', 'HR', 'Sicherstellen, dass kritisches Wissen und laufende Aufgaben an Nachfolger oder Team übergeben werden.', 'identitat', NULL, 15, 'HR', true, true, 5, 30, true, '2026-04-27 07:07:09.937826+00'),
	(33, 3, 'ob_badge_key_return', 'Schlüssel und Badge zurückgeben', 'HR', 'Ausweis, Schlüssel und sonstige Zugangsmittel von der ausscheidenden Person einziehen.', 'identitat', NULL, 15, 'HR', true, true, 1, 40, true, '2026-04-27 07:07:09.937826+00'),
	(34, 3, 'ob_babtec_user_disable', 'Babtec-User deaktivieren', 'Fachanwendungen', 'Babtec-Zugang der ausscheidenden Person deaktivieren.', 'babtec', NULL, 16, 'QS', true, true, 2, 200, true, '2026-04-27 07:07:09.937826+00'),
	(36, 4, 'dc_gewatec_access_update', 'Gewatec-Zugang anpassen', 'Fachanwendungen', 'Gewatec-Berechtigungen auf die neue Abteilung umstellen.', 'gewatec', NULL, 4, 'AV', true, true, 3, 210, true, '2026-04-27 07:07:09.952433+00'),
	(37, 4, 'dc_provis_access_update', 'Provis-Zugang anpassen', 'Fachanwendungen', 'Provis-Berechtigungen auf die neue Abteilung umstellen.', 'berechtigungen', NULL, 3, 'AV', true, true, 3, 220, true, '2026-04-27 07:07:09.952433+00'),
	(38, 4, 'dc_ad_group_update', 'AD-Gruppen aktualisieren', 'Zugänge', 'AD-Gruppen und Berechtigungen auf die neue Abteilung umstellen, alte abteilungsspezifische Gruppen entfernen.', 'ad_user', NULL, 12, 'IT', true, true, 2, 100, true, '2026-04-27 07:07:09.952433+00'),
	(2, 1, 'consense_setup', 'Consense User anlegen', 'Fachanwendungen', 'Consense-User fuer die neue Person anlegen.', 'consense', NULL, 1, 'QMB', true, true, 3, 230, true, '2026-04-27 07:07:09.732801+00'),
	(21, 3, 'ob_consense_user_disable', 'Consense-User deaktivieren', 'Fachanwendungen', 'Consense-Zugang der ausscheidenden Person deaktivieren.', 'consense', NULL, 1, 'QMB', true, true, 2, 230, true, '2026-04-27 07:07:09.937826+00'),
	(35, 4, 'dc_consense_access_update', 'Consense-Zugang anpassen', 'Fachanwendungen', 'Consense-Berechtigungen auf die neue Abteilung umstellen.', 'consense', NULL, 1, 'QMB', true, true, 3, 230, true, '2026-04-27 07:07:09.952433+00'),
	(39, 4, 'dc_drive_access_update', 'Laufwerk-Zugänge anpassen', 'Zugänge', 'Netzlaufwerk-Zugriffsrechte anpassen: Zugriff auf neue Abteilungs-Laufwerke gewähren, alte entziehen.', 'pc', NULL, 12, 'IT', true, true, 2, 110, true, '2026-04-27 07:07:09.952433+00'),
	(76, 7, 'rc_babtec_access_update', 'Babtec-Zugang anpassen', 'Fachanwendungen', 'Babtec-Rollen oder Berechtigungen an die neue Rolle anpassen.', 'babtec', NULL, 16, 'QS', true, true, 3, 220, true, '2026-04-27 07:07:10.043952+00'),
	(40, 4, 'dc_email_alias_update', 'E-Mail Alias anpassen', 'Zugänge', 'E-Mail Alias des Mitarbeiters aktualisieren, falls die neue Abteilung einen anderen Kürzel erfordert.', 'mailbox', NULL, 11, 'IT', true, true, 3, 120, true, '2026-04-27 07:07:09.952433+00'),
	(42, 4, 'dc_ln_access_update', 'InforLN-Zugang anpassen', 'Fachanwendungen', 'InforLN-Berechtigungen auf die neue Abteilung umstellen.', 'react', NULL, 9, 'IT', true, true, 3, 140, true, '2026-04-27 07:07:09.952433+00'),
	(43, 4, 'dc_hardware_swap', 'Hardware tauschen', 'Ausstattung', 'Hardware der neuen Arbeitsanforderungen entsprechend tauschen (z. B. stationär durch Laptop ersetzen).', 'pc', NULL, 8, 'IT', true, true, 2, 150, true, '2026-04-27 07:07:09.952433+00'),
	(44, 4, 'dc_change_date_confirmed', 'Wechseldatum bestätigen', 'HR', 'Bestätigen, dass das Wechseldatum eingetroffen ist. Schaltet alle Zugangs- und Ausstattungsaufgaben frei.', 'identitat', NULL, 15, 'HR', true, true, 1, 10, true, '2026-04-27 07:07:09.952433+00'),
	(45, 4, 'dc_hr_system_update', 'Abteilung im HR-System aktualisieren', 'HR', 'Abteilung des Mitarbeiters in der Personalakte und im HR-System auf die neue Abteilung umstellen.', 'identitat', NULL, 15, 'HR', true, true, 3, 20, true, '2026-04-27 07:07:09.952433+00'),
	(46, 4, 'dc_babtec_access_update', 'Babtec-Zugang anpassen', 'Fachanwendungen', 'Babtec-Berechtigungen auf die neue Abteilung umstellen.', 'babtec', NULL, 16, 'QS', true, true, 3, 200, true, '2026-04-27 07:07:09.952433+00'),
	(47, 5, 'nc_ad_username_update', 'AD-Benutzername aktualisieren', 'Zugaenge', 'AD-Benutzername, Anzeigename und verzeichnisbezogene Namensfelder auf den neuen Namen umstellen.', 'ad_user', NULL, 12, 'IT', true, true, 2, 100, true, '2026-04-27 07:07:09.964804+00'),
	(48, 5, 'nc_system_display_name_update', 'Anzeigenamen in Systemen aktualisieren', 'Systeme', 'Anzeigenamen in angeschlossenen Systemen und Verzeichnissen auf den neuen Namen angleichen.', 'berechtigungen', NULL, 12, 'IT', true, true, 3, 120, true, '2026-04-27 07:07:09.964804+00'),
	(49, 5, 'nc_mailbox_update', 'Mailbox und Alias aktualisieren', 'Zugaenge', 'Mailbox, primäre Adresse und Alias auf den neuen Namen umstellen.', 'mailbox', NULL, 11, 'IT', true, true, 2, 110, true, '2026-04-27 07:07:09.964804+00');
INSERT INTO public.task_templates OVERRIDING SYSTEM VALUE VALUES
	(50, 5, 'nc_effective_date_confirmed', 'Wirksamkeitsdatum bestaetigen', 'HR', 'Bestaetigen, dass das Wirksamkeitsdatum erreicht ist. Schaltet die technischen Umstellungsaufgaben frei.', 'identitat', NULL, 15, 'HR', true, true, 1, 10, true, '2026-04-27 07:07:09.964804+00'),
	(51, 5, 'nc_hr_master_data_update', 'HR-Stammdaten aktualisieren', 'HR', 'Neuen Namen in Personalakte und HR-Stammdaten pflegen.', 'identitat', NULL, 15, 'HR', true, true, 2, 20, true, '2026-04-27 07:07:09.964804+00'),
	(53, 6, 'pc_gewatec_access_update', 'Gewatec-Zugang anpassen', 'Fachanwendungen', 'Gewatec-Berechtigungen auf die neue Position umstellen.', 'gewatec', NULL, 4, 'AV', true, true, 3, 230, true, '2026-04-27 07:07:10.029253+00'),
	(54, 6, 'pc_provis_access_update', 'Provis-Zugang anpassen', 'Fachanwendungen', 'Provis-Berechtigungen auf die neue Position umstellen.', 'berechtigungen', NULL, 3, 'AV', true, true, 3, 240, true, '2026-04-27 07:07:10.029253+00'),
	(55, 6, 'pc_permission_profile_update', 'Berechtigungsprofil aktualisieren', 'Berechtigungen', 'Allgemeine Berechtigungsprofile und Freigaben an die neue Position anpassen.', 'ad_user', NULL, 12, 'IT', true, true, 2, 100, true, '2026-04-27 07:07:10.029253+00'),
	(56, 6, 'pc_ad_groups_update', 'AD-Gruppen aktualisieren', 'Zugaenge', 'AD-Gruppen und Rollen entsprechend der neuen Position anpassen.', 'ad_user', NULL, 12, 'IT', true, true, 2, 120, true, '2026-04-27 07:07:10.029253+00'),
	(57, 6, 'pc_drive_access_update', 'Laufwerk-Zugaenge anpassen', 'Zugaenge', 'Datei- und Laufwerksberechtigungen auf die Anforderungen der neuen Position umstellen.', 'pc', NULL, 12, 'IT', true, true, 2, 130, true, '2026-04-27 07:07:10.029253+00'),
	(58, 6, 'pc_mailbox_update', 'Mailbox und Alias anpassen', 'Zugaenge', 'Mailbox-bezogene Sichtbarkeit oder Aliasdaten an die neue Position anpassen.', 'mailbox', NULL, 11, 'IT', true, true, 3, 140, true, '2026-04-27 07:07:10.029253+00'),
	(59, 6, 'pc_habel_access_update', 'Habel-Zugang anpassen', 'Fachanwendungen', 'Habel-Berechtigungen auf die neue Position umstellen.', 'habel', NULL, 10, 'IT', true, true, 3, 200, true, '2026-04-27 07:07:10.029253+00'),
	(60, 6, 'pc_ln_access_update', 'InforLN-Zugang anpassen', 'Fachanwendungen', 'InforLN-Berechtigungen auf die neue Position umstellen.', 'react', NULL, 9, 'IT', true, true, 3, 210, true, '2026-04-27 07:07:10.029253+00'),
	(61, 6, 'pc_change_date_confirmed', 'Wechseldatum bestaetigen', 'HR', 'Bestaetigen, dass das Wechseldatum fuer die neue Position erreicht ist. Schaltet Folgeaufgaben frei.', 'identitat', NULL, 15, 'HR', true, true, 1, 10, true, '2026-04-27 07:07:10.029253+00'),
	(62, 6, 'pc_hr_master_data_update', 'Position in HR-Stammdaten aktualisieren', 'HR', 'Neue Position in Personalakte und HR-Stammdaten nachfuehren.', 'identitat', NULL, 15, 'HR', true, true, 2, 20, true, '2026-04-27 07:07:10.029253+00'),
	(63, 6, 'pc_training_assign', 'Schulungen einplanen', 'Qualifizierung', 'Noetige Schulungen und Einweisungen fuer die neue Position planen und dokumentieren.', 'identitat', NULL, 15, 'HR', true, true, 5, 110, true, '2026-04-27 07:07:10.029253+00'),
	(64, 6, 'pc_babtec_access_update', 'Babtec-Zugang anpassen', 'Fachanwendungen', 'Babtec-Berechtigungen auf die neue Position umstellen.', 'babtec', NULL, 16, 'QS', true, true, 3, 220, true, '2026-04-27 07:07:10.029253+00'),
	(66, 7, 'rc_gewatec_access_update', 'Gewatec-Zugang anpassen', 'Fachanwendungen', 'Gewatec-Rollen oder Berechtigungen an die neue Rolle anpassen.', 'gewatec', NULL, 4, 'AV', true, true, 3, 230, true, '2026-04-27 07:07:10.043952+00'),
	(67, 7, 'rc_provis_access_update', 'Provis-Zugang anpassen', 'Fachanwendungen', 'Provis-Rollen oder Berechtigungen an die neue Rolle anpassen.', 'berechtigungen', NULL, 3, 'AV', true, true, 3, 240, true, '2026-04-27 07:07:10.043952+00'),
	(68, 7, 'rc_role_assignment_update', 'Rollen-Zuweisung aktualisieren', 'Berechtigungen', 'Fachliche und technische Rollen der betroffenen Person auf die neue Rolle umstellen.', 'ad_user', NULL, 12, 'IT', true, true, 2, 100, true, '2026-04-27 07:07:10.043952+00'),
	(69, 7, 'rc_permission_profile_update', 'Berechtigungsprofil aktualisieren', 'Berechtigungen', 'Weitere Berechtigungsprofile und Freigaben an die neue Rolle anpassen.', 'berechtigungen', NULL, 12, 'IT', true, true, 2, 110, true, '2026-04-27 07:07:10.043952+00'),
	(70, 7, 'rc_ad_groups_update', 'AD-Gruppen aktualisieren', 'Zugaenge', 'AD-Gruppen und Verzeichnisrollen an die neue Rolle anpassen.', 'ad_user', NULL, 12, 'IT', true, true, 2, 120, true, '2026-04-27 07:07:10.043952+00'),
	(71, 7, 'rc_mailbox_update', 'Mailbox und Alias anpassen', 'Zugaenge', 'Mailboxbezogene Sichtbarkeit oder Aliasrechte an die neue Rolle anpassen.', 'mailbox', NULL, 11, 'IT', true, true, 3, 130, true, '2026-04-27 07:07:10.043952+00'),
	(72, 7, 'rc_habel_access_update', 'Habel-Zugang anpassen', 'Fachanwendungen', 'Habel-Rollen oder Berechtigungen an die neue Rolle anpassen.', 'habel', NULL, 10, 'IT', true, true, 3, 200, true, '2026-04-27 07:07:10.043952+00'),
	(73, 7, 'rc_ln_access_update', 'InforLN-Zugang anpassen', 'Fachanwendungen', 'InforLN-Rollen oder Berechtigungen an die neue Rolle anpassen.', 'react', NULL, 9, 'IT', true, true, 3, 210, true, '2026-04-27 07:07:10.043952+00'),
	(74, 7, 'rc_effective_date_confirmed', 'Wirksamkeitsdatum bestaetigen', 'HR', 'Bestaetigen, dass das Wirksamkeitsdatum fuer den Rollenwechsel erreicht ist. Schaltet Folgeaufgaben frei.', 'identitat', NULL, 15, 'HR', true, true, 1, 10, true, '2026-04-27 07:07:10.043952+00'),
	(75, 7, 'rc_hr_master_data_update', 'Rolle in HR-Stammdaten aktualisieren', 'HR', 'Neue Rolle in Personalakte und HR-Stammdaten nachfuehren.', 'identitat', NULL, 15, 'HR', true, true, 2, 20, true, '2026-04-27 07:07:10.043952+00'),
	(65, 7, 'rc_consense_access_update', 'Consense-Zugang anpassen', 'Fachanwendungen', 'Consense-Rollen oder Berechtigungen an die neue Rolle anpassen.', 'consense', NULL, 1, 'QMB', true, true, 3, 250, true, '2026-04-27 07:07:10.043952+00'),
	(52, 6, 'pc_consense_access_update', 'Consense-Zugang anpassen', 'Fachanwendungen', 'Consense-Berechtigungen auf die neue Position umstellen.', 'consense', NULL, 1, 'QMB', true, true, 3, 250, true, '2026-04-27 07:07:10.029253+00');
...
INSERT INTO public.task_template_conditions OVERRIDING SYSTEM VALUE VALUES
	(1, 2, 1, 'consense_requested', 'is_true', NULL, true, NULL, '2026-04-27 07:07:09.737877+00'),
	(2, 3, 1, 'gewatec_requested', 'is_true', NULL, true, NULL, '2026-04-27 07:07:09.737877+00'),
	(3, 4, 1, 'provis_requested', 'is_true', NULL, true, NULL, '2026-04-27 07:07:09.737877+00'),
	(4, 5, 1, 'ad_user_requested', 'is_true', NULL, true, NULL, '2026-04-27 07:07:09.737877+00'),
	(5, 6, 1, 'comparison_user_available', 'is_true', NULL, true, NULL, '2026-04-27 07:07:09.737877+00'),
	(6, 6, 1, 'ad_user_requested', 'is_true', NULL, true, NULL, '2026-04-27 07:07:09.737877+00'),
	(7, 7, 1, 'internet_requested', 'is_true', NULL, true, NULL, '2026-04-27 07:07:09.737877+00'),
	(8, 8, 1, 'internal_drive_access_requested', 'is_true', NULL, true, NULL, '2026-04-27 07:07:09.737877+00'),
	(9, 9, 1, 'mailbox_requested', 'is_true', NULL, true, NULL, '2026-04-27 07:07:09.737877+00'),
	(10, 10, 1, 'habel_user_requested', 'is_true', NULL, true, NULL, '2026-04-27 07:07:09.737877+00'),
	(11, 11, 1, 'ln_user_requested', 'is_true', NULL, true, NULL, '2026-04-27 07:07:09.737877+00'),
	(12, 12, 1, 'microsoft_office_requested', 'is_true', NULL, true, NULL, '2026-04-27 07:07:09.737877+00'),
	(13, 13, 1, 'hardware_available', 'is_false', NULL, false, NULL, '2026-04-27 07:07:09.737877+00'),
	(14, 13, 1, 'hardware_requested', 'is_true', NULL, true, NULL, '2026-04-27 07:07:09.737877+00'),
	(15, 14, 1, 'hardware_requested', 'is_true', NULL, true, NULL, '2026-04-27 07:07:09.737877+00'),
	(16, 15, 1, 'hardware_requested', 'is_true', NULL, true, NULL, '2026-04-27 07:07:09.737877+00'),
	(17, 16, 1, 'phone_requested', 'is_true', NULL, true, NULL, '2026-04-27 07:07:09.737877+00'),
	(18, 17, 1, 'catia_requested', 'is_true', NULL, true, NULL, '2026-04-27 07:07:09.737877+00'),
	(19, 18, 1, 'datev_requested', 'is_true', NULL, true, NULL, '2026-04-27 07:07:09.737877+00'),
	(20, 19, 1, 'tiso_requested', 'is_true', NULL, true, NULL, '2026-04-27 07:07:09.737877+00'),
	(21, 20, 1, 'babtec_requested', 'is_true', NULL, true, NULL, '2026-04-27 07:07:09.737877+00'),
	(22, 21, 1, 'ob_has_consense', 'is_true', NULL, true, NULL, '2026-04-27 07:07:09.941178+00'),
	(23, 22, 1, 'ob_has_gewatec', 'is_true', NULL, true, NULL, '2026-04-27 07:07:09.941178+00'),
	(24, 23, 1, 'ob_has_provis', 'is_true', NULL, true, NULL, '2026-04-27 07:07:09.941178+00'),
	(25, 24, 1, 'ob_has_ad_account', 'is_true', NULL, true, NULL, '2026-04-27 07:07:09.941178+00'),
	(26, 25, 1, 'ob_has_mailbox', 'is_true', NULL, true, NULL, '2026-04-27 07:07:09.941178+00'),
	(27, 26, 1, 'ob_has_habel', 'is_true', NULL, true, NULL, '2026-04-27 07:07:09.941178+00'),
	(28, 27, 1, 'ob_has_ln', 'is_true', NULL, true, NULL, '2026-04-27 07:07:09.941178+00'),
	(29, 28, 1, 'ob_has_hardware', 'is_true', NULL, true, NULL, '2026-04-27 07:07:09.941178+00'),
	(30, 29, 1, 'ob_has_phone', 'is_true', NULL, true, NULL, '2026-04-27 07:07:09.941178+00'),
	(31, 31, 1, 'ob_exit_interview', 'is_true', NULL, true, NULL, '2026-04-27 07:07:09.941178+00'),
	(32, 32, 1, 'ob_knowledge_transfer', 'is_true', NULL, true, NULL, '2026-04-27 07:07:09.941178+00'),
	(33, 34, 1, 'ob_has_babtec', 'is_true', NULL, true, NULL, '2026-04-27 07:07:09.941178+00'),
	(34, 35, 1, 'dc_has_consense', 'is_true', NULL, true, NULL, '2026-04-27 07:07:09.955789+00'),
	(35, 36, 1, 'dc_has_gewatec', 'is_true', NULL, true, NULL, '2026-04-27 07:07:09.955789+00'),
	(36, 37, 1, 'dc_has_provis', 'is_true', NULL, true, NULL, '2026-04-27 07:07:09.955789+00'),
	(37, 38, 1, 'dc_ad_group_change', 'is_true', NULL, true, NULL, '2026-04-27 07:07:09.955789+00'),
	(38, 39, 1, 'dc_drive_access_change', 'is_true', NULL, true, NULL, '2026-04-27 07:07:09.955789+00'),
	(39, 40, 1, 'dc_email_alias_change', 'is_true', NULL, true, NULL, '2026-04-27 07:07:09.955789+00'),
	(40, 41, 1, 'dc_has_habel', 'is_true', NULL, true, NULL, '2026-04-27 07:07:09.955789+00'),
	(41, 42, 1, 'dc_has_ln', 'is_true', NULL, true, NULL, '2026-04-27 07:07:09.955789+00'),
	(42, 43, 1, 'dc_hardware_change', 'is_true', NULL, true, NULL, '2026-04-27 07:07:09.955789+00'),
	(43, 46, 1, 'dc_has_babtec', 'is_true', NULL, true, NULL, '2026-04-27 07:07:09.955789+00'),
	(44, 52, 1, 'pc_has_consense', 'is_true', NULL, true, NULL, '2026-04-27 07:07:10.032975+00'),
	(45, 53, 1, 'pc_has_gewatec', 'is_true', NULL, true, NULL, '2026-04-27 07:07:10.032975+00'),
	(46, 54, 1, 'pc_has_provis', 'is_true', NULL, true, NULL, '2026-04-27 07:07:10.032975+00'),
	(47, 55, 1, 'pc_permission_change', 'is_true', NULL, true, NULL, '2026-04-27 07:07:10.032975+00'),
	(48, 56, 1, 'pc_ad_groups_change', 'is_true', NULL, true, NULL, '2026-04-27 07:07:10.032975+00'),
	(49, 57, 1, 'pc_drive_access_change', 'is_true', NULL, true, NULL, '2026-04-27 07:07:10.032975+00'),
	(50, 58, 1, 'pc_mail_alias_change', 'is_true', NULL, true, NULL, '2026-04-27 07:07:10.032975+00');
INSERT INTO public.task_template_conditions OVERRIDING SYSTEM VALUE VALUES
	(51, 59, 1, 'pc_has_habel', 'is_true', NULL, true, NULL, '2026-04-27 07:07:10.032975+00'),
	(52, 60, 1, 'pc_has_ln', 'is_true', NULL, true, NULL, '2026-04-27 07:07:10.032975+00'),
	(53, 63, 1, 'pc_training_required', 'is_true', NULL, true, NULL, '2026-04-27 07:07:10.032975+00'),
	(54, 64, 1, 'pc_has_babtec', 'is_true', NULL, true, NULL, '2026-04-27 07:07:10.032975+00'),
	(55, 65, 1, 'rc_has_consense', 'is_true', NULL, true, NULL, '2026-04-27 07:07:10.046954+00'),
	(56, 66, 1, 'rc_has_gewatec', 'is_true', NULL, true, NULL, '2026-04-27 07:07:10.046954+00'),
	(57, 67, 1, 'rc_has_provis', 'is_true', NULL, true, NULL, '2026-04-27 07:07:10.046954+00'),
	(58, 68, 1, 'rc_role_assignment_change', 'is_true', NULL, true, NULL, '2026-04-27 07:07:10.046954+00'),
	(59, 69, 1, 'rc_permission_change', 'is_true', NULL, true, NULL, '2026-04-27 07:07:10.046954+00'),
	(60, 70, 1, 'rc_ad_groups_change', 'is_true', NULL, true, NULL, '2026-04-27 07:07:10.046954+00'),
	(61, 71, 1, 'rc_mailbox_change', 'is_true', NULL, true, NULL, '2026-04-27 07:07:10.046954+00'),
	(62, 72, 1, 'rc_has_habel', 'is_true', NULL, true, NULL, '2026-04-27 07:07:10.046954+00'),
	(63, 73, 1, 'rc_has_ln', 'is_true', NULL, true, NULL, '2026-04-27 07:07:10.046954+00'),
	(64, 76, 1, 'rc_has_babtec', 'is_true', NULL, true, NULL, '2026-04-27 07:07:10.046954+00');
...
INSERT INTO public.workflow_answer_derivation_rules OVERRIDING SYSTEM VALUE VALUES
	(1, 1, 3, 'has_ad_account', 'ob_has_ad_account', 'copy_boolean', true, 1, '2026-04-27 07:07:10.014855+00'),
	(2, 1, 3, 'has_babtec', 'ob_has_babtec', 'copy_boolean', true, 2, '2026-04-27 07:07:10.014855+00'),
	(3, 1, 3, 'has_consense', 'ob_has_consense', 'copy_boolean', true, 3, '2026-04-27 07:07:10.014855+00'),
	(4, 1, 3, 'has_gewatec', 'ob_has_gewatec', 'copy_boolean', true, 4, '2026-04-27 07:07:10.014855+00'),
	(5, 1, 3, 'has_habel', 'ob_has_habel', 'copy_boolean', true, 5, '2026-04-27 07:07:10.014855+00'),
	(6, 1, 3, 'has_hardware', 'ob_has_hardware', 'copy_boolean', true, 6, '2026-04-27 07:07:10.014855+00'),
	(7, 1, 3, 'has_ln', 'ob_has_ln', 'copy_boolean', true, 7, '2026-04-27 07:07:10.014855+00'),
	(8, 1, 3, 'has_mailbox', 'ob_has_mailbox', 'copy_boolean', true, 8, '2026-04-27 07:07:10.014855+00'),
	(9, 1, 3, 'has_phone', 'ob_has_phone', 'copy_boolean', true, 9, '2026-04-27 07:07:10.014855+00'),
	(10, 1, 3, 'has_provis', 'ob_has_provis', 'copy_boolean', true, 10, '2026-04-27 07:07:10.014855+00'),
	(11, 1, 4, 'has_ad_account', 'dc_ad_group_change', 'copy_boolean', true, 1, '2026-04-27 07:07:10.019728+00'),
	(12, 1, 4, 'has_babtec', 'dc_has_babtec', 'copy_boolean', true, 2, '2026-04-27 07:07:10.019728+00'),
	(13, 1, 4, 'has_consense', 'dc_has_consense', 'copy_boolean', true, 3, '2026-04-27 07:07:10.019728+00'),
	(14, 1, 4, 'has_gewatec', 'dc_has_gewatec', 'copy_boolean', true, 4, '2026-04-27 07:07:10.019728+00'),
	(15, 1, 4, 'has_habel', 'dc_has_habel', 'copy_boolean', true, 5, '2026-04-27 07:07:10.019728+00'),
	(16, 1, 4, 'has_hardware', 'dc_hardware_change', 'copy_boolean', true, 6, '2026-04-27 07:07:10.019728+00'),
	(17, 1, 4, 'has_ln', 'dc_has_ln', 'copy_boolean', true, 7, '2026-04-27 07:07:10.019728+00'),
	(18, 1, 4, 'has_provis', 'dc_has_provis', 'copy_boolean', true, 8, '2026-04-27 07:07:10.019728+00');
...
INSERT INTO public.workflow_node_configs OVERRIDING SYSTEM VALUE VALUES
	(7, 20, '{"legacyProcessTypeKey": "offboarding"}', '2026-04-27 07:07:10.374109+00'),
	(8, 24, '{"legacyProcessTypeKey": "department_change"}', '2026-04-27 07:07:10.377381+00'),
	(9, 28, '{"legacyProcessTypeKey": "name_change"}', '2026-04-27 07:07:10.385153+00'),
	(10, 32, '{"legacyProcessTypeKey": "position_change"}', '2026-04-27 07:07:10.389326+00'),
	(11, 36, '{"legacyProcessTypeKey": "role_change"}', '2026-04-27 07:07:10.392633+00'),
	(12, 40, '{"legacyProcessTypeKey": "onboarding"}', '2026-04-27 07:07:10.396926+00');
