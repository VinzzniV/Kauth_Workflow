...
INSERT INTO public.action_definitions
	(id, action_key, name, description, handler_type, parameter_schema_json, is_active, requires_approval, is_idempotent, created_at, updated_at, target_runtime, max_attempts_override, subsequent_retry_delay_seconds_override)
OVERRIDING SYSTEM VALUE VALUES
	(1, 'CreateAdUser', 'Create AD User', 'Simulated creation of an Active Directory user.', 'simulated_directory', '{"type": "object", "additionalProperties": true}', true, false, true, '2026-04-27 07:07:09.400545+00', '2026-04-27 07:07:10.354481+00', NULL, NULL, NULL),
	(2, 'CreateMailbox', 'Create Mailbox', 'Simulated provisioning of a mailbox.', 'simulated_mailbox', '{"type": "object", "additionalProperties": true}', true, false, true, '2026-04-27 07:07:09.400545+00', '2026-04-27 07:07:10.354481+00', NULL, NULL, NULL),
	(3, 'AssignGroups', 'Assign Groups', 'Simulated assignment of directory groups.', 'simulated_directory_groups', '{"type": "object", "additionalProperties": true}', true, false, true, '2026-04-27 07:07:09.400545+00', '2026-04-27 07:07:10.354481+00', NULL, NULL, NULL),
	(4, 'CreateErpEmployee', 'Create ERP Employee', 'Simulated creation of an ERP employee.', 'simulated_erp', '{"type": "object", "additionalProperties": true}', true, false, false, '2026-04-27 07:07:09.400545+00', '2026-04-27 07:07:10.354481+00', NULL, NULL, NULL),
	(5, 'SendWelcomeMail', 'Send Welcome Mail', 'Simulated sending of a welcome email.', 'simulated_notification', '{"type": "object", "additionalProperties": true}', true, false, true, '2026-04-27 07:07:09.400545+00', '2026-04-27 07:07:10.354481+00', NULL, NULL, NULL),
	(6, 'SimulatedWindowsWorkerPing', 'Windows-Worker Ping (Skeleton-Test)', 'Simulierter Handler im Windows-Worker. Beweist den Transport- und Audit-Pfad ohne AD-Zugriff. Payload {"delaySeconds": N} verzoegert die Antwort fuer Stale-Claim-Tests.', 'simulated_windows_worker_ping', '{"type": "object", "additionalProperties": true}', true, false, true, '2026-05-12 00:00:00+00', '2026-05-12 00:00:00+00', 'windows_worker', NULL, NULL),
	(7, 'CreateAdUserLdaps', 'Create AD User (LDAPS)', 'Echte AD-User-Anlage via LDAPS gegen on-prem-DC. Laeuft im Windows-Worker unter gMSA. Pflicht-Payload-Felder: samAccountName, userPrincipalName, displayName, givenName, surname, mail, targetOu. Optional: employeeNumber. Output liefert distinguishedName, samAccountName, userPrincipalName und temporaryPassword (Force-Change-at-Next-Logon).', 'windows_worker_ldaps', '{"type":"object","required":["samAccountName","userPrincipalName","displayName","givenName","surname","mail","targetOu"],"additionalProperties":true}', true, false, true, '2026-05-12 00:00:00+00', '2026-05-12 00:00:00+00', 'windows_worker', NULL, NULL),
	(8, 'AssignGroupsLdaps', 'Assign AD Groups (LDAPS)', 'Fuegt den AD-User in N AD-Gruppen ein via LDAPS-ModifyRequest. Laeuft im Windows-Worker unter gMSA. Pflicht-Payload-Felder: userDistinguishedName (via created_ad_user-Source), groupDistinguishedNames (string array). Output liefert newlyAdded + alreadyMember + ggf. failed.', 'windows_worker_ldaps_groups', '{"type":"object","required":["userDistinguishedName","groupDistinguishedNames"],"additionalProperties":true}', true, false, true, '2026-05-12 00:00:00+00', '2026-05-12 00:00:00+00', 'windows_worker', NULL, NULL),
	(9, 'SendWelcomeMailGraph', 'Send Welcome Mail (Graph)', 'Versendet die Willkommens-Mail an einen frisch angelegten User via Microsoft Graph (App-only). Linux-side. Catalog-Template welcome_mail mit {{temporary_password}}-Placeholder. Pflicht-Payload inkl. credentialVaultId (UUID, Vault-Pointer aus CreateAdUserLdaps; Handler entschluesselt zur Run-time).', 'graph_welcome_mail', '{"type":"object","required":["toAddress","recipientName","firstName","lastName","userPrincipalName","credentialVaultId"],"additionalProperties":true}', true, false, true, '2026-05-13 00:00:00+00', '2026-05-13 00:00:00+00', NULL, NULL, NULL),
	(10, 'CreateMailboxGraph', 'Create Exchange Mailbox (Graph)', 'Weist via Microsoft Graph (App-only) eine Exchange-Online-Lizenz zu. Mailbox wird durch Exchange Online automatisch provisioniert. Pflicht-Payload: userPrincipalName (typischerweise ueber created_ad_user.userPrincipalName-Mapping) + skuId (UUID). Output: primarySmtpAddress (echte beobachtete SMTP) + licenseSkuId + assignedAtUtc. Retry-Override 10/300 = ~41 min fuer den Entra-Connect-Sync. Pflicht-Permissions: User.Read.All + LicenseAssignment.ReadWrite.All.', 'graph_mailbox_provision', '{"type":"object","required":["userPrincipalName","skuId"],"additionalProperties":true}', true, false, true, '2026-05-13 00:00:00+00', '2026-05-13 00:00:00+00', NULL, 10, 300),
	(11, 'DisableAdUserLdaps', 'Disable AD User (LDAPS)', 'Deaktiviert einen AD-User via LDAPS gegen den on-prem-DC. Laeuft im Windows-Worker unter gMSA. Setzt das ACCOUNTDISABLE-Bit (userAccountControl |= 0x2). Idempotent: bereits deaktivierter User liefert Success mit alreadyDisabled=true. Pflicht-Payload: userDistinguishedName (DN des Users, typischerweise aus CreateAdUserLdaps-Output). Output: distinguishedName, alreadyDisabled (bool). FailureKind: Payload-Validierung + LDAP-Codes 49/50/21/19 -> permanent; alles andere -> transient.', 'windows_worker_ldaps', '{"type":"object","required":["userDistinguishedName"],"additionalProperties":true}', true, false, true, '2026-05-19 00:00:00+00', '2026-05-19 00:00:00+00', 'windows_worker', NULL, NULL),
	(12, 'RemoveFromAllGroupsLdaps', 'Remove from All Groups (LDAPS)', 'Entfernt einen AD-User aus allen Gruppen via LDAPS gegen den on-prem-DC. Laeuft im Windows-Worker unter gMSA. Sucht per LDAP-Filter (&(objectClass=group)(member=<dn>)) alle Gruppen und entfernt den User pro Gruppe via ModifyRequest (Operation=Delete). Idempotent: Code 16 (NoSuchAttribute = bereits kein Mitglied) wird als AlreadyRemoved behandelt. Pflicht-Payload: userDistinguishedName. Output: removed (neu entfernte DNs), alreadyRemoved (bereits nicht Mitglied), failed (fehlgeschlagene Gruppen). FailureKind: Payload-Validierung + LDAP-Codes 49/50/32/21/19 -> permanent; partielle Fehler mit permanent-Anteil -> permanent; alles andere -> transient.', 'windows_worker_ldaps', '{"type":"object","required":["userDistinguishedName"],"additionalProperties":true}', true, false, true, '2026-05-19 00:00:00+00', '2026-05-19 00:00:00+00', 'windows_worker', NULL, NULL),
	(13, 'RemoveMailboxLicense', 'Remove Exchange Mailbox License (Graph)', 'Entfernt eine Exchange-Online-Lizenz von einem Entra-User via Microsoft Graph (App-only). Idempotent: Lizenz nicht zugewiesen liefert Success mit licenseNotAssigned=true. Pflicht-Payload: userPrincipalName (UPN-Format) + skuId (UUID). Output: userPrincipalName, licenseSkuId, licenseNotAssigned (bool), removedAtUtc (null wenn licenseNotAssigned). FailureKind: Payload-Validierung + User-Not-Found + Permissions-Fehler (401/403) -> permanent; 429 + 5xx + Timeouts -> transient. Pflicht-Permissions: User.Read.All + LicenseAssignment.ReadWrite.All (Admin-Consent).', 'graph_mailbox_deprovision', '{"type":"object","required":["userPrincipalName","skuId"],"additionalProperties":true}', true, false, true, '2026-05-19 00:00:00+00', '2026-05-19 00:00:00+00', NULL, NULL, NULL),
	(14, 'MoveAdUserOuLdaps', 'AD-User in OU verschieben (LDAPS)', 'Verschiebt einen AD-User per LDAP ModifyDN in eine andere Organisationseinheit. Der RDN (CN) bleibt unveraendert. Laeuft im Windows-Worker unter gMSA. Idempotent: User bereits in Ziel-OU -> Success mit alreadyInTargetOu=true. Pflicht-Payload: userDistinguishedName (aktueller DN), targetOu (Ziel-OU-DN). Output: distinguishedName, fromOu, toOu, alreadyInTargetOu. FailureKind: Payload-Validierung + User-Not-Found + LDAP-Codes 49/50/32/21/19 -> permanent; alles andere -> transient.', 'windows_worker_ldaps', '{"type":"object","required":["userDistinguishedName","targetOu"],"additionalProperties":true}', true, false, true, '2026-05-19 00:00:00+00', '2026-05-19 00:00:00+00', 'windows_worker', NULL, NULL),
	(15, 'UpdateAdUserAttributesLdaps', 'AD-User-Attribute aktualisieren (LDAPS)', 'Aktualisiert eine Whitelist von AD-User-Attributen via LDAPS. Whitelist: managerDistinguishedName (->manager), department, title, description. Kein UPN/mail/displayName/cn/sAMAccountName (Identity-Slice). JSON null = Attribut loeschen (Replace auf leere Liste). Fehlendes Key = nicht anfassen. Idempotent: keine Aenderung noetig -> NoChangesNeeded -> Success mit noChangesNeeded=true. Pflicht-Payload: userDistinguishedName + mindestens ein Whitelist-Feld. Output: distinguishedName, changedAttributes (LDAP-Attributnamen), noChangesNeeded. FailureKind: Payload-Validierung + User-Not-Found + LDAP-Codes 49/50/32/21/19 -> permanent; alles andere -> transient.', 'windows_worker_ldaps', '{"type":"object","required":["userDistinguishedName"],"additionalProperties":true}', true, false, true, '2026-05-19 00:00:00+00', '2026-05-19 00:00:00+00', 'windows_worker', NULL, NULL);
...
INSERT INTO public.workflow_nodes (
	...
	(19, 2, 'start', 'start', 'Start', 0, NULL, NULL, NULL, '2026-04-27 07:07:10.374109+00'),
	(20, 2, 'collect_requirements', 'form', 'Offboarding-Umfang erfassen', 10, NULL, NULL, NULL, '2026-04-27 07:07:10.374109+00'),
	(21, 2, 'department_setup', 'measure_deprovision', 'Entzugsmaßnahmen erzeugen', 20, NULL, NULL, NULL, '2026-04-27 07:07:10.374109+00'),
	(22, 2, 'end', 'end', 'Abschluss', 30, NULL, NULL, NULL, '2026-04-27 07:07:10.374109+00'),
	(23, 3, 'start', 'start', 'Start', 0, NULL, NULL, NULL, '2026-04-27 07:07:10.377381+00'),
	(24, 3, 'collect_requirements', 'form', 'Wechselumfang erfassen', 10, NULL, NULL, NULL, '2026-04-27 07:07:10.377381+00'),
	(25, 3, 'department_setup', 'measure_change', 'Änderungsmaßnahmen erzeugen', 20, NULL, NULL, NULL, '2026-04-27 07:07:10.377381+00'),
	(26, 3, 'end', 'end', 'Abschluss', 30, NULL, NULL, NULL, '2026-04-27 07:07:10.377381+00'),
	(27, 4, 'start', 'start', 'Start', 0, NULL, NULL, NULL, '2026-04-27 07:07:10.385153+00'),
	(28, 4, 'collect_requirements', 'form', 'Namensänderung erfassen', 10, NULL, NULL, NULL, '2026-04-27 07:07:10.385153+00'),
	(29, 4, 'department_setup', 'measure_rename', 'Umbenennungsmaßnahmen erzeugen', 20, NULL, NULL, NULL, '2026-04-27 07:07:10.385153+00'),
	(30, 4, 'end', 'end', 'Abschluss', 30, NULL, NULL, NULL, '2026-04-27 07:07:10.385153+00'),
	(31, 5, 'start', 'start', 'Start', 0, NULL, NULL, NULL, '2026-04-27 07:07:10.389326+00'),
	(32, 5, 'collect_requirements', 'form', 'Positionswechsel erfassen', 10, NULL, NULL, NULL, '2026-04-27 07:07:10.389326+00'),
	(33, 5, 'department_setup', 'measure_change', 'Änderungsmaßnahmen erzeugen', 20, NULL, NULL, NULL, '2026-04-27 07:07:10.389326+00'),
	(34, 5, 'end', 'end', 'Abschluss', 30, NULL, NULL, NULL, '2026-04-27 07:07:10.389326+00'),
	(35, 6, 'start', 'start', 'Start', 0, NULL, NULL, NULL, '2026-04-27 07:07:10.392633+00'),
	(36, 6, 'collect_requirements', 'form', 'Rollenwechsel erfassen', 10, NULL, NULL, NULL, '2026-04-27 07:07:10.392633+00'),
	(37, 6, 'department_setup', 'measure_change', 'Änderungsmaßnahmen erzeugen', 20, NULL, NULL, NULL, '2026-04-27 07:07:10.392633+00'),
	(38, 6, 'end', 'end', 'Abschluss', 30, NULL, NULL, NULL, '2026-04-27 07:07:10.392633+00'),
	(39, 1, 'start', 'start', 'Start', 0, NULL, NULL, NULL, '2026-04-27 07:07:10.396926+00'),
	(40, 1, 'collect_requirements', 'form', 'Anforderungen erfassen', 10, NULL, NULL, NULL, '2026-04-27 07:07:10.396926+00'),
	(41, 1, 'department_setup', 'measure_provision', 'Bereitstellungsmaßnahmen erzeugen', 20, NULL, NULL, NULL, '2026-04-27 07:07:10.396926+00'),
	(42, 1, 'end', 'end', 'Abschluss', 30, NULL, NULL, NULL, '2026-04-27 07:07:10.396926+00');
...
SELECT pg_catalog.setval('public.action_definitions_id_seq', 15, true);
