...
**Stand**: 2026-05-08 — Z18, FE-8, A1 und A2 vollstaendig abgeschlossen. A2 liefert neue Admin-Sektion „Aus Entra importieren" mit vollstaendiger Import-UI. Naechster Schritt: A3 (Mitarbeiterkarte fehlende Felder) oder B (Entra-Stellenbezeichnungen) oder C (Verzeichnis UNION).
