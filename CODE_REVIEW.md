...
**Stand**: 2026-05-08 — Z18 vollstaendig abgeschlossen. FE-8 abgeschlossen. A1 (People-Import Backend-Fundament) abgeschlossen: `POST /admin/people/import-from-directory` + `GET /admin/directory/unlinked-identities` implementiert und getestet. Kein weiterer aktiver Zyklus offen. Naechster Schritt: A2 (Import-UI) oder C (Verzeichnis UNION).
