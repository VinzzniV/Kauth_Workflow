...
**Nächster Slice:** Etappe 9a Schritt 6 — Temporary-Credentials-Vault als eigene Architektur-Entscheidung, `CreateMailbox`/`CreateErpEmployee` als eigene Backend-Slices, optional Connection-Pooling.
