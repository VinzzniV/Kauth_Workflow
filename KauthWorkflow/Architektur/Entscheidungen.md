...
**Nächster Slice:** `CreateErpEmployee` (ERP-System-Auswahl mit Stakeholder) als eigener Backend-Architektur-Slice; optional Workflow-Engine-Branch-on-automation-output fuer AlreadyExists-Faelle, `RemoveMailboxLicense`, Lizenz-Pool-Monitoring, Connection-Pooling, Vault-Cleanup, Key-Rotation.
