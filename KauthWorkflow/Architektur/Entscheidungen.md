...
**Nächster Slice:** Etappe 9a Schritt 5 — Temporary-Credentials-Vault, `AssignGroups`-LDAPS-Handler, `SendWelcomeMail` real, `CreateMailbox`/`CreateErpEmployee` (eigene Backend-Slices), optional Connection-Pooling im LdapsAdUserWriter.
