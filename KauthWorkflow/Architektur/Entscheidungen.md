...
**Nächster Slice:** Etappe 9a Schritt 4 — Error-Klassifikation generalisieren, Linux-API Stale-Worker-Claim-Sweep, Temporary-Credentials-Vault, Migration der restlichen `simulated_*`-Handler.
