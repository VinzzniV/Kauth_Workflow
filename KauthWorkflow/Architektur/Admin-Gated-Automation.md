...
| 8 | Change-/Offboarding-Handler | 🟡 teilweise done — `DisableAdUserLdaps`, `RemoveFromAllGroupsLdaps`, `RemoveMailboxLicense` implementiert (Commit `0b9d225`); Change-Workflow-Handler (`MoveAdUserOuLdaps`, `UpdateAdUserAttributesLdaps`, `RenameAdUserLdaps`) noch offen | `worker/AdAutomationWorker.Core/Handlers/`, `db/manual/2026-05-19_seed_disable_*`, `db/manual/2026-05-19_seed_remove_*`, `db/02_bootstrap.sql`, `db/02_dev_seed.sql` |
