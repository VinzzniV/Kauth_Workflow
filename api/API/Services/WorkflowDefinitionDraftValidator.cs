...
// Z7-3.4: Draft-Validierungspfad — wirft InvalidOperationException bei Fehlern.
// Wird vom WorkflowDefinitionValidationService ueber NormalizeDefinitionKey/ValidateAndNormalize delegiert.
internal static class WorkflowDefinitionDraftValidator
{
    ...
    public static string NormalizeDefinitionKey(string? definitionKey)
        => WorkflowDefinitionValidationHelpers.NormalizeRequiredKey(definitionKey, "Definition key");

    public static WorkflowDefinitionDraftValidationResult ValidateAndNormalize(ReplaceWorkflowDefinitionVersionRequest request)
    {
