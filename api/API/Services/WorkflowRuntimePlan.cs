...
{
    // Engine-computed status from active node types. Apply MAY override when
    // RequiresStatusRecalc=true (measure_* nodes active, DB recalc needed).
    ...
    // statt ComputedStatus persistieren. Diese DB-Recalc-Logik mit Tasks/
