...
internal interface IWorkflowLifecycleService
{
    ...
    Task OnExternalAutomationJobSucceededAsync(long jobId, CancellationToken cancellationToken);
    Task OnExternalAutomationJobFailedAsync(long jobId, CancellationToken cancellationToken);
