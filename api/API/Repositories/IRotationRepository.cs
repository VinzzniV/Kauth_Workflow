...
internal interface IRotationRepository
{
    ...
    Task<RotationStationDto?> CreateRotationStation(long planId, RotationStationUpsertRequest request);
    Task<RotationStationDto?> UpdateRotationStation(long stationId, RotationStationUpsertRequest request);
    Task<bool> DeleteRotationStation(long stationId);
