...
- **Naechster Schritt:** Z10-1.2 Vertrags-Skizze (HIGH/high/opus) — pro Endpunkt aus der Z10-1.1-Inventur entscheiden: `limit`/`offset` vs. Cursor, Server-`search`, stabiler `sort`, Antwort-Hull, FE-Adaption-Folgen. Z10-1.1 Inventur ist done (Bloecke A Identity, B Master-Data, C Directory, D Builder, E Notification-Templates, F Rotation, G Runtime-Subresources, H Startable in `CODE_REVIEW.md` § Z10-1.1).
